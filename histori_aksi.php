...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["selesai"])) {
    ...
    if ($update_result && $delete_result) {
        header("Location: histori_admin.php?message=Pengajuan dengan NIM/NIP <b>$username</b> sudah berhasil diverifikasi");
    } else {
        $error_message = mysqli_error($koneksi);
        header("Location: histori_admin.php?message=Gagal: " . $error_message);
    }
}
