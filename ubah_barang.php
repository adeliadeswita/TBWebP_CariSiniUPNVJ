        ...
        <div class="container mt-3 border rounded bg-white py-4 px-5 mb-5">
            ...
            <section>
                ...
                <form action="ubah_barang.php" method="post" class="form" enctype="multipart/form-data">
                    ...
                    <div>
                        <input type="submit" name="submit" value="Ubah" class="btn float-start" style="width: 100px; background-color: #65C18C; color: white;" onmouseenter="this.style.backgroundColor='#186F65'" onmouseout="this.style.backgroundColor='#65C18C'">
                    </div>
                </form>
            </section>
